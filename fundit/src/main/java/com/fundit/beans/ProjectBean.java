...
public class ProjectBean {
	...
	private Integer project_fund_required;
	
	private Integer project_fund_received;
	
	private String project_my_fund;
	...
	public String getProject_my_fund() {
		return project_my_fund;
	}

	public void setProject_my_fund(String project_my_fund) {
