...
public class ProjectDao {
	...
	public boolean addProject(ProjectBean projectBean) {
		...
		try {
			...
			pstmt.setString(6, projectBean.getProject_planned_finish_date().substring(0,8));
			pstmt.setInt(7, projectBean.getProject_fund_required());
			pstmt.setInt(8, projectBean.getProject_fund_received());
			pstmt.setString(9, projectBean.getUser_id());
			pstmt.setString(10, projectBean.getProject_my_fund());
